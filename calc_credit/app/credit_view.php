...
<form action="<?php print(_APP_URL);?>/app/credit.php" method="post">
	...
	<label for="procent">Oprocentowanie (%): </label>
	    <input id="procent" type="text" name="procent" value="<?php isset($procent)?print($procent):""; ?>" /><br />
    <label for="okres">Okres (lata): </label>
	    <input id="okres" type="number" name="okres" value="<?php isset($okres)?print($okres):""; ?>" /><br />
